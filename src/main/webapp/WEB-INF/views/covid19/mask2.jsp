...
<body>
	...
	const url = 'https://8oi9s0nnth.apigw.ntruss.com/corona19-masks/v1/storesByGeo/json?lat=37.553419&lng=126.971585&m=5000';
		...
		.then((myJson) => { 
			...
			const stores = myJson.stores;
				for (var i = 0; i < stores.length; i++) {
					...
					//마커가 표시될 위치
					var markerPosition = new kakao.maps.LatLng(stores[i]["lat"], stores[i]["lng"]); 
					
					//인포윈도우 텍스트에 담을 변수 생성
					var iwContent = stores[i]["name"] + 재고;
